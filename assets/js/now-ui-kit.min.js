...
$(document).ready(function() {
    ...
    }), 992 <= $(window).width() && (big_image = $('.page-header-image[data-parallax="true"]'), $(window).on("scroll", nowuiKit.checkScrollForParallax)), $(".carousel").carousel({
        interval: 4e3
    ...
    $toggle = $(this), 1 == nowuiKit.misc.navbar_menu_visible ? ($("html").removeClass("nav-open"), nowuiKit.misc.navbar_menu_visible = 0, $("#bodyClick").remove(), setTimeout(function() {
        ...
        $("html").removeClass("nav-open"), nowuiKit.misc.navbar_menu_visible = 0, setTimeout(function() {
            $toggle.removeClass("toggled"), $("#bodyClick").remove(), 0 != $("#navbar-right").length && 0 != $("#navbar-middle").length && ($("#navbar-right").append($("#navbar-middle>.navbar-extend")), $("#navbar-right").find(".navbar-extend").removeClass("navbar-extend"))
        }, 550)
    }), $("html").addClass("nav-open"), nowuiKit.misc.navbar_menu_visible = 1, 0 != $("#navbar-right").length && 0 != $("#navbar-middle").length && ($("#navbar-right").find("li").addClass("navbar-extend"), $("#navbar-middle").append($("#navbar-right>li"))))
}), nowuiKit = {
    misc: {
